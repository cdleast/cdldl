    ...
    <div class="register">
        <section class="form_container">
            <div class="manage_tip">
                ...
                <!-- :model="registerUser --- 表单数据对象 -->
                <!-- :rules="rules" --- 表单验证规则 -->
                <!-- ref="registerForm" --- 帮助我们获取表单里的内容 -->
                ...
                >
                    ...
                    <!-- @click="submitForm('registerForm')" 把整个form(ref)表单传过去 -->
                    <el-form-item>
                        <el-button
                            type="primary"
                            class="submit_btn"
            ...
            rules: {
                name: [
                    // 用户名
                    {
                        ...
                        message: "用户名不能为空", // 验证失败提示信息
                        trigger: "blur" // 什么时候触发 是否在 rules 属性改变后立即触发一次验证
                    },
                    {
                        min: 2, // 最小长度
                        max: 30, // 最大长度
                        message: "长度在 2 到 30 个字符", // 验证失败提示信息
